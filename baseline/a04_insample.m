...
%% Set time ranges
stime = qq(2011,1); %starting point of the first simulation 
                    %stime-1 is the initial state
                    %stime is the first simulated time period
etime = qq(2025,4); %the end of the known history
       
%% Selection of model variables to include in the report:

list_xnames = {'DLA_CPI','D4L_CPI','L_GDP_GAP','L_S'}; 
...
in_sample_report(pE, stime,etime,list_xnames)
